...
struct Token {
    enum Type {
        ...
        OP_ASSIGNMENT, OP_PLUS, OP_MINUS, OP_MULTIPLY, OP_DIVIDE, OP_MODULO, OP_EXPONENT,
        OP_PLUS_EQUALS, OP_MINUS_EQUALS, OP_MULTIPLY_EQUALS, OP_DIVIDE_EQUALS, OP_MODULO_EQUALS, OP_EXPONENT_EQUALS,
        IDENT, NUMBER, STRING,
...
inline const std::string type_to_string(Token::Type type) {
    switch (type) {
        ...
        case Token::Type::OP_EXPONENT: return "OP_EXPONENT";
        ...
        case Token::Type::OP_EXPONENT_EQUALS: return "OP_EXPONENT_EQUALS";
